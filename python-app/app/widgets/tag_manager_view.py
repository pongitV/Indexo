...
class TagEditDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.txt_keywords.setPlaceholderText("ex: contrato, acordo, assinatura, prestacao de servico")
    ...
    def save_and_accept(self):
        ...
        if not name:
            QMessageBox.warning(self, "Indexo", "Nome da tag não pode ficar vazio.")
            return
...
class TagManagerView(QWidget):
    ...
    def init_ui(self):
        ...
        self.table_system.setHorizontalHeaderLabels([
            tr("tags.name"), tr("tags.category"), tr("tags.keywords"), tr("tags.confidence"), "Ações / Actions"
        ])
        ...
        self.table_user.setHorizontalHeaderLabels([
            tr("tags.name"), tr("tags.category"), tr("tags.keywords"), tr("tags.caminho_fisico"), "Ações / Actions"
        ])
