...
class LiteModeView(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_apply = QPushButton("Renomear Apenas (Sem Mover)")
    ...
    def apply_renames(self):
        ...
        if not to_rename:
            QMessageBox.information(self, "Indexo", "Nenhum arquivo selecionado para renomear.")
            return

        msg = f"Deseja realmente renomear os {len(to_rename)} arquivos selecionados no disco?"
        ...
        QMessageBox.information(self, "Indexo", f"{applied} arquivos foram renomeados com sucesso!")
        self.scan_and_plan()
