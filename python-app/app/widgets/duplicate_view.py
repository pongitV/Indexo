...
class DuplicateView(QWidget):
    ...
    def init_ui(self):
        ...
        self.lbl_list_title = QLabel(f"{tr('nav.duplicates')} (Selecione para comparar abaixo):")
        ...
        self.lbl_comp_title = QLabel("Comparação Detalhada das Cópias:")
    ...
    def mark_for_deletion_prompt(self, file_data: Dict[str, Any]):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                ...
                QMessageBox.critical(self, "Erro", f"Falha ao marcar arquivo: {e}")
